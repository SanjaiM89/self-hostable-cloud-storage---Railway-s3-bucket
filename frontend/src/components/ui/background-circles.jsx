...
const AnimatedGrid = () => (
    ...
    >
        <div className="h-full w-full [background-image:repeating-linear-gradient(100deg,#64748B_0%,#64748B_1px,transparent_1px,transparent_4%)] opacity-15 dark:opacity-25" />
    </motion.div>
);
    ...
    return (
        ...
        >
            ...
            {showContent && (
                ...
                >
                    <h1 className="text-5xl font-bold tracking-tight md:text-7xl bg-gradient-to-b from-slate-950 to-slate-700 dark:from-slate-100 dark:to-slate-300 bg-clip-text text-transparent drop-shadow-[0_0_32px_rgba(94,234,212,0.4)]">
                        {title}
                    </h1>
                    <motion.p
            ...
            <div className="absolute inset-0 [mask-image:radial-gradient(90%_60%_at_50%_50%,#000_40%,transparent)]">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,#0F766E/25%,transparent_70%)] blur-[120px]" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,#2DD4BF/12%,transparent)] blur-[80px]" />
            </div>
        </div>
    );
}
