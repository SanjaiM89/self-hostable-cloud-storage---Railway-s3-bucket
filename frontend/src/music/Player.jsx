...
import { Play, Pause, SkipBack, SkipForward, Volume2, VolumeX, Repeat, Shuffle, Maximize2, Music } from 'lucide-react';

export default function Player({ currentSong, isPlaying, onTogglePlay, audioRef }) {
    ...
    return (
        <div className="bg-[var(--bg-secondary)] border-t border-[var(--border-color)] p-3 flex items-center justify-between h-20 shadow-lg backdrop-blur-md bg-opacity-95">
            {/* Song Info */}
            <div className="flex items-center w-1/4 min-w-0">
                <div className="w-12 h-12 rounded bg-gray-700 mr-3 overflow-hidden flex-shrink-0">
            ...
            <div className="flex flex-col items-center w-2/4 px-2">
                <div className="flex items-center gap-4 mb-1">
                    ...
                    <button className="text-[var(--text-primary)] hover:text-[var(--accent)]"><SkipForward size={20} fill="currentColor" /></button>
